...
public class UtteranceNormalizerTests
{
    ...
    [TestCase("設定を開いてください。", "ja", "設定", false)]
    [TestCase("klacksy、シフト表はどこですか？", "ja", "シフト表", true)]
    [TestCase("欠勤を表示していただけますか", "ja", "欠勤", false)]
    [TestCase("プロフィールを確認したい", "ja", "プロフィール", false)]
    [TestCase("ダッシュボードに移動してください", "ja", "ダッシュボード", false)]
    [TestCase("レポートどこ？", "ja", "レポート", false)]
    [TestCase("勤務表見せて", "ja", "勤務表", false)]
    [TestCase("打开设置", "zh-CN", "设置", false)]
    [TestCase("请给我看加班", "zh-CN", "加班", false)]
    [TestCase("你好klacksy，打开设置吧", "zh-CN", "设置", true)]
    [TestCase("给我看加班", "zh-CN", "加班", false)]
    [TestCase("请帮我查看排班表", "zh-CN", "排班表", false)]
    [TestCase("麻烦你帮我打开个人资料", "zh-CN", "个人资料", false)]
    [TestCase("报表在哪里？", "zh-CN", "报表", false)]
    [TestCase("请假在哪", "zh-CN", "请假", false)]
    [TestCase("进入仪表盘吧", "zh-CN", "仪表盘", false)]
    [TestCase("可以帮我打开设置吗？", "zh-CN", "设置", false)]
    [TestCase("你好klacksy，看一下缺勤记录", "zh-CN", "缺勤记录", true)]
    [TestCase("顯示加班", "zh-TW", "加班", false)]
    [TestCase("請幫我開啟設定", "zh-TW", "設定", false)]
    [TestCase("請假總覽在哪裡？", "zh-TW", "請假總覽", false)]
    [TestCase("我想看班表", "zh-TW", "班表", false)]
    [TestCase("麻煩幫我打開個人資料，謝謝", "zh-TW", "個人資料", false)]
    [TestCase("檢視報表", "zh-TW", "報表", false)]
    [TestCase("幫我查看一下加班", "zh-TW", "加班", false)]
    [TestCase("請帶我去儀表板吧", "zh-TW", "儀表板", false)]
    [TestCase("เปิดการตั้งค่าหน่อย", "th", "การตั้งค่า", false)]
    [TestCase("ขอดูตารางงานหน่อยครับ", "th", "ตารางงาน", false)]
    [TestCase("รบกวนเปิดโปรไฟล์ได้ไหมคะ", "th", "โปรไฟล์", false)]
    [TestCase("ไปที่หน้าการตั้งค่านะครับ", "th", "หน้าการตั้งค่า", false)]
    [TestCase("การลาอยู่ที่ไหน", "th", "การลา", false)]
    [TestCase("ช่วยแสดงรายงานให้หน่อยค่ะ", "th", "รายงาน", false)]
    [TestCase("ไปที่หน้าหลักหน่อย", "th", "หน้าหลัก", false)]
    [TestCase("ตั้งค่าครับ", "th", "ตั้งค่า", false)]
